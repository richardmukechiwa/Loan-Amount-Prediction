...
# Define the paths to your model and pipeline files
model_path = "artifacts/model_trainer/model.joblib"
pipeline_path = "artifacts/model_trainer/pipeline.joblib"

# Create a config object
config = Config(model_path, pipeline_path)
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=8080, debug=True)from flask import Flask, render_template, request
import numpy as np
from pathlib import Path
from credit_risk.pipeline.prediction import PredictionPipeline
